...
<head>
  <title>Truck Driving School at AIT in Las Vegas,Nevada</title>
    
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <META NAME="DESCRIPTION" CONTENT="CDL Classes are available in Las Vegas,Nevada at our Truck Driving School.">
		...
		<!-- Start: Header -->
		 ...
		 <div class="row">
		 	 	 <section class="small-12 column noPad">
		 	 	 	<img style="min-width:100%;" src="../header.jpg" alt="Truck driving school in Las Vegas,Nevada">
		 	 	 </section>
