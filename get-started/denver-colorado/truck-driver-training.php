...
<head>
  ...
  <META NAME="DESCRIPTION" CONTENT="Truck driver training is available in Denver,Colorado at our Truck Driving School.">
		...
		<!-- Start: Header -->
		 ...
		 <div class="row">
		 	 	 <section class="small-12 column noPad">
		 	 	 	<img style="min-width:100%;" src="../header.jpg" alt="Truck driver training in Denver,Colorado">
		 	 	 </section>
		  ...
		  <div class="row">
			  <div class="columns small-12">
				  ...
				  <h1>Truck Driver Training in Denver, Colorado</h1>
