...
<head>
  ...
  <META NAME="DESCRIPTION" CONTENT="CDL School in Denver,Colorado at our Truck Driving School.">
		...
		<!-- Start: Header -->
		 ...
		 <div class="row">
		 	 	 <section class="small-12 column noPad">
		 	 	 	<img style="min-width:100%;" src="../header.jpg" alt="CDL School in Denver,Colorado">
		 	 	 </section>
		  ...
		  <div class="row">
			  <div class="columns small-12">
				  ...
				  <h1>CDL School in Denver, Colorado</h1>
...
<!-- Parent Campaign ID-->
<input name="00Nj00000095OEC" type="hidden" value="701j0000001QQtp" />  
<!-- Record ID-->
