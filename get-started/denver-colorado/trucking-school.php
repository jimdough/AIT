...
<head>
  <title>Trucking School at AIT in Denver,Colorado</title>
    
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <META NAME="DESCRIPTION" CONTENT="CDL Classes are available in Denver,Colorado at our Trucking School.">
		...
		<!-- Start: Header -->
		 ...
		 <div class="row">
		 	 	 <section class="small-12 column noPad">
		 	 	 	<img style="min-width:100%;" src="../header.jpg" alt="Trucking school in Denver,Colorado">
		 	 	 </section>
		  ...
		  <div class="row">
			  <div class="columns small-12">
				  ...
				  <h1>Trucking school in Denver, Colorado</h1>
