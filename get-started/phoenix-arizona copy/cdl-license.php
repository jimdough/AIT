		...
		<!-- Start: Header -->
		 ...
		 <div class="row">
		 	 	 <section class="small-12 column noPad">
		 	 	 	<img style="min-width:100%;" src="../header.jpg" alt="CDL License in Phoenix,Arizona">
		 	 	 </section>
		  ...
		  <div class="row">
			  <div class="columns small-12">
				  ...
				  <h1>CDL License training in Phoenix, Arizona</h1>
				  
				  <p>CDL License Training teaches the essential skills needed to pass the CDL exam. AIT Truck Driver Training goes well beyond the basics and prepares our graduates for life on the road as professional truck drivers for major transportation carriers! All truck driving schools train for this CDL License exam, but equally important is the preparation needed for life on the road to become an outstanding Professional Truck Driver and not all CDL classes include this valuable information.</p>

<p>CDL License classes at AIT’s truck driving school in Phoenix, Arizona, prepare students for their careers as a Professional Truck Driver. AIT's experienced instructors teach students the proper techniques for driving tractor trailers, tracking miles and time through log management, coupling trailers, and performing pre- and post-trip inspections. In addition, AIT's comprehensive career training is focused on encouraging growth well beyond the basics.</p>

<p>Through AIT’s comprehensive CDL classes, hands-on training and its incredible team of instructors, you can complete CDL training in as little as four weeks! AIT’s training programs, job placement assistance, and carrier opportunities will have you on the path to becoming a Professional Truck Driver in no time!</p>
