		...
		<!-- Start: Header -->
		 ...
		 <div class="row">
		 	 	 <section class="small-12 column noPad">
		 	 	 	<img style="min-width:100%;" src="../header.jpg" alt="CDL Training in Denver,Colorado">
		 	 	 </section>
...
Henderson CO 80640</h6>
	 	...
	 	<div class="uneditable row">
		 	<div class="columns small-12 text-center">
			 	<p>
			 	<a class="radius button large" href="http://www.ait-schools.com/?utm_source=landing%20page&utm_medium=ppc&utm_campaign=Denver%20PPC%20Referral">Go to AIT Home Page</a>
			 	</p>
