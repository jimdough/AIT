...
<html class="no-js" lang="en" >
	...
	<head>
	  <title>Las Vegas, NV - AIT Truck Driving School</title>
	  <?php include("inc/head.inc"); ?>
	  <meta name="DESCRIPTION" content="CDL truck driving school at AIT in Las Vegas, NV">
	...
	<body>
		...
		<div class="wrapper">
			...
			<div class="row">
				<section class="editable small-12 large-8 column" id="untitled-region-1"><h1>North Las Vegas, Nevada - Truck Driving School</h1>
<p>Our Las Vegas, NV truck driving school offers high quality CDL training. We provide ample hands-on training in all of the courses we offer, with high quality equipment and job training. Call or contact us today for more information.</p>
<p><b>AIT’s North Las Vegas truck driver training location is right off the I-15 and Lamb Boulevard.</b></p>
<p>If you are coming from downtown Las Vegas, take the I-15 north. Get off on Lamb Boulevard and make a right heading south. Go about a quarter mile and make a right on Lone Mountain Road. AIT will be on the right hand side of the road.</p>
...
<li><a href="#"><img class="logo-icon" src="migration/NVDMV-135x110.jpg" alt="CDL truck driving school at AIT in Las Vegas, NV"></a></li>
<li><a href="#"><img class="logo-icon" src="migration/nta-135x110.jpg" alt="CDL truck driving school at AIT in Las Vegas, NV"></a></li>
</ul>
</div>
</div></section>
					...
					<div class="widget">
					 	...
					 	<address> 
							<ul class="list-unstyled">
				                <li> <i class="icon-home"></i>American Institute of Trucking<br>4020 E. Lone Mountain Rd.<br>North Las Vegas, NV 89081</li>
				                <!--<li> <i class="icon-envelope-alt"></i><a href="mailto:youremail@example.com">youremail@example.com </a></li>-->
				                <li> <i class="icon-phone-sign"></i>1(702) 644-0155</li> 
				            </ul>
						</address>
					</div>
					<div class="widget">
...
<!-- Parent Campaign ID-->
<input name="00Nj00000095OEC" type="hidden" value="701j0000001Z5Xe" />  
<!-- Record ID-->
...
<p class="disclaimer">By submitting this form you are expressly consenting to our <a href="http://www.ait-schools.com/terms-of-use.php" target="_blank">Terms of Use.</a> You are also expressly consenting to have American Institute of Trucking, Inc. (the “Company”) or its representative, including its Affiliated Companies, Partners, and third party service providers (collectively, “Affiliates”), contact you about your inquiry or about the products and services offered by this Company, its Affiliated Companies, partners, and third party providers.  You are further consenting that such contact may be by text message or phone (including by use of automatic telephone dialing system(s) or an artificial or prerecorded voice) to the residential or cellular telephone number you have provided above, even if such number is listed on a corporate, state or national Do Not Call Registry. You do not have to agree to receive such calls or messages as a condition of receiving any services from American Institute of Trucking, Inc. or its Affiliates. For additional information concerning the above consents please see our <a href="http://www.ait-schools.com/terms-of-use.php" target="_blank">Terms of Use</a> page.</p>
		...
		<script type="text/javascript">
			 ...
			 *  */
			var latitude = "36.248110";
			var longitude = "-115.085849";
			var details = "American Institute of Trucking - North Las Vegas Campus";
