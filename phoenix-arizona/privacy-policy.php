...
<html>
 ...
 <body>
	 ...
	 <p><b>Information that is gathered from visitors</b><br>
...
website.<br>
Where registration is required, the visitor's email and a personal info may be 
stored on the server.<br>
<br>
<b>How the Information is used</b><br>
The information is used to enhance the vistor's experience when using the 
website to display personalized content and possibly advertising.<br>
...
may be used to track your return visits to the website.<br>
