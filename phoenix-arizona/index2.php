...
<body>
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-K8ZFM6"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-K8ZFM6');</script>
<!-- End Google Tag Manager -->
	...
	<div class="wrapper editable">
		...
		<!-- Start: Header -->
		 ...
		 <div class="row">
		 	 	 <section class="small-12 column noPad text-center">
		 	 	 	<img style="min-width:100%;" src="header.jpg" alt="AIT Truck Driver Training header">
		 	 	 </section>
		  </div>	 <!-- End Row-->
		 ...
		 <div class="row">
			  <div class="columns small-12">
				   <h1>Why are Professional Truck Drivers in such high demand?</h1>
...
<h3>Don’t be fooled into thinking this is an exclusive career. Professional Truck Driving is a role fit for anyone with a clean driving record, a Class A CDL, and a will to succeed!</h3>
...
<p>The Professional Truck Driving Industry, already a market with competitive positions, is about to face a rising peak in demand throughout the next ten years. American Trucking Associations (ATA) figures an additional 89,000 drivers a year are needed to support America’s steadily growing economy in the next decade. Due to things like the replacement of retiring truck drivers and industry growth, the Professional Truck Driving Industry is in need of qualified drivers that will help nurture America’s growing economy. </p>
		  ...
		  <div class="row">
		 			<div class="columns small-12 medium-6 large-6 noPad">
			 			<a id="formJump"></a>
				 			<div id="form-top" class="text-center">
					 			<h2 style="margin-top: 0;">Apply Now To Get Started!</h2>
				 			</div>
...
<!-- Parent Campaign ID-->
<input name="00Nj00000095OEC" type="hidden" value="701j0000001Z5Os" />  
<!-- Record ID-->
<input id="recordType" name="recordType" type="hidden" value="012j0000000mEIt" />
<!--Return URL-->  		 
<input type="hidden" name="retURL" value="http://www.ait-schools.com/confirmation-ppc.php">
<!-- Sets Lead Source-->
...
<input type="image" src="button1000.jpg" border="0" name="submit" value="Apply Now">
</div>
</div>
...
<p class="disclaimer">By submitting this form you are expressly consenting to our <a href="http://www.ait-schools.com/terms-of-use.php" target="_blank">Terms of Use.</a> You are also expressly consenting to have American Institute of Trucking, Inc. (the “Company”) or its representative, including its Affiliated Companies, Partners, and third party service providers (collectively, “Affiliates”), contact you about your inquiry or about the products and services offered by this Company, its Affiliated Companies, partners, and third party providers.  You are further consenting that such contact may be by text message or phone (including by use of automatic telephone dialing system(s) or an artificial or prerecorded voice) to the residential or cellular telephone number you have provided above, even if such number is listed on a corporate, state or national Do Not Call Registry. You do not have to agree to receive such calls or messages as a condition of receiving any services from American Institute of Trucking, Inc. or its Affiliates. For additional information concerning the above consents please see our <a href="http://www.ait-schools.com/terms-of-use.php" target="_blank">Terms of Use</a> page.</p>
		 			...
		 			<h3>Pay & Benefits for Trucking Careers</h3>
			  	
		 			<p>AIT-trained truck drivers become valued assets to their employing carrier companies. Carriers choose to invest in their employees by offering sought-after benefits such as health & dental insurance, competitive salaries, tuition reimbursement terms, retirement plans, stock purchase options, paid time off, and wellness programs. In short, carriers are looking for safe, dependable truck drivers and AIT training prepares those drivers for long-term, secure careers.</p>
			 			
			 	<h3>The American trucking industry needs drivers!</h3>
			 			
			 	<ul class="yes-bullet">
			  		<li>Starting pay averaging <b>$40,900<span class="asterisk">**</span></b> per year</li>
			  ...
			  <h3>AIT Truck Driver Training offers:</h3>
			  ...
			  <ul class="yes-bullet">
					...
					<li>Classes that focus on CDL training and Class A CDL license exam preparation</li>
					<li>3 training locations</li>
					<li>Financial aid for those who qualify</li>
			  	</ul>
			  
			  		 	<div class="show-for-small text-center"><a class="radius button large success" href="#formJump">Apply Now to Get Started!</a></div>
	 	...
	 	<div id="form-top2" class="uneditable row">			 
			 			<div class="text-center columns large-4">
						<h7>Denver, Colorado Campus</h7>
						<p style="color: #fff;">9239 Brighton Rd., #201<br>
						Henderson CO 80640<br>
						Phone: (303) 558-3152</p>
			 			</div>

						<div class="text-center columns large-4">
						<h7>Phoenix, Arizona Campus</h7>
						<p style="color: #fff;">440 S. 54th Ave.<br>
						Phoenix, AZ 85043<br>
						Phone: (602) 457-3294</p>
						</div>
						
						<div class="text-center columns large-4">
						<h7>Las Vegas, Nevada Campus</h7>
						<p style="color: #fff;">4020 E. Lone Mountain Rd.<br>
						North Las Vegas, NV 89081<br>
						Phone: (702) 623-3434</p>
						</div>

				 	</div>
		 	
		 <div class="columns small-12 text-center">
			 	<p><a class="radius button large" href="http://www.ait-schools.com/?utm_source=landing%20page&utm_medium=ppc&utm_campaign=Catch%20All%20Referral
">Go to AIT Home Page</a></p>
